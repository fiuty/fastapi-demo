...
class Message(Base):
    ...
    conversation_id: Mapped[int] = mapped_column(
        Integer, ForeignKey("t_conversation.id", ondelete="CASCADE"), nullable=False, index=True, comment="会话ID"
    )
    ...
    extra_meta: Mapped[str | None] = mapped_column("extra_meta", Text, nullable=True, comment="附加元数据(JSON)")
